...
public class CategoryFormValidator implements Validator {
    ...
    public boolean supports(Class<?> clazz) {
        return CategoryFormObject.class.equals(clazz);
    }

    @Override
    public void validate(Object target, Errors errors) {

        CategoryFormObject category = (CategoryFormObject) target;
    ...
    private void checkOnCommonNames(CategoryFormObject category, Errors errors){
    ...
    private void checkOnExistingCategories(CategoryFormObject object, Errors errors, Collection<Product> existCategories){
        if (!object.isUpdate()){
