    ...
    <div class="col-9 pt-5">
        ...
        <div class="content__mainpart__product__description">
            ...
            <div class="description_container" style="width: 100%;">
                <div class="desc_text">
                    <%--<b>Rating: </b> <i style="margin-left: 20px">${rating}</i> <a href="#">Edit parameters</a> <br><br>--%>
                ...
                <div class="product_pane">
                    ...
                    <div class="product_pane_buy_btn">
                        <a href="<c:url value="/admin/showUpdateForm">
                                    <c:param name="prod_id" value="${prod.id}"/>
                                 </c:url>" class="product_pane_buy_btn_link">
                            Edit
                        </a>
                        <a href="<c:url value="/admin/showCreateForm"/>" class="product_pane_buy_btn_link">
                            Add
                        </a>
                    </div>
